 ...
 * produced by a separate agent from the full transcript: ~10-minute sections,
 * in-character cleaned quotes, each section aware of prior context. Companion to
 * the shorter /streszczenie-ug2. Rendered through the shared Markdown component.
 */
...
Zanim cokolwiek wydarzyło się w fikcji, Strażnik Tajemnic zwrócił się do graczy poza fabułą. Wyliczył, czego mają się spodziewać: że grają zwartą, dziarską grupą gangsterów, którzy mogą sobie nawzajem ufać, nie mają mrocznych sekretów ani powodów do zdrady, mogą ufać szefowi traktującemu ich jak rodzinę, a przy mądrej grze ich szanse na przeżycie są naprawdę spore. Na koniec dorzucił przewrotną uwagę:

> **Strażnik Tajemnic:** „Dodam też, że jedna z rzeczy, które powiedziałem, nie jest do końca prawdą. Ale tylko jedna. Wam zostawiam rozkminienie, którą mam na myśli — zanim będzie za późno."

Nieprawdą okazało się pierwsze zdanie: gracze nie tworzyli jednej grupy gangsterów. W rzeczywistości istniały dwie drużyny — gangsterzy i akademicy — i to był cały twist, a nie wewnętrzna zdrada.

Ustalono też nazwę speakeasy. Po krótkiej naradzie stanęło na klubie **Rhymers Club**, ulokowanym w **Old State House** — starym budynku stanowym. Następnie każdy gangster opisał swój typowy dzień. **Mortimer „Mort" Flannery**, gruby siostrzeniec szefa i jego prawa ręka, budził się w apartamencie, gdzie czekał już na dole jego kierowca i ochroniarz Fritz; dzień wypełniały spotkania z księgowym, nadzór nad importem w dokach, a wieczorem klub dżentelmeński i ocenianie dzieł sztuki.

> **Mortimer Flannery:** „Bardziej pasjonuje mnie posiadanie czegoś, czego inni nie mają."

**Cormac McMiller** przedstawił się jako księgowy — i to konkretnie księgowy Mortimera, nie samego McBride'a, mający wąską specjalizację i utrzymujący kontakty w Towarzystwie Księgowym Arkham, gdzie wymienia się plotki o klientach. **Friedrich „Fritz" Mueller**, niemiecki imigrant po wojnie o niepełni uregulowanym statusie, opisał się jako lojalny kierowca-ochroniarz na wyłączność organizacji, który nie gardzi tym, co zostaje po nieboszczykach. Bracia **Kelly** — **Joseph** (silniejszy) i **James** (zawodowy bokser) — zaczynali dzień na siłowni i wspólnym sparingu bokserskim.

<img src="/img/ug2/mcbride.jpg" alt="Declan McBride" width="220" align="right" style="margin: 0.3rem 0 0.8rem 1.2rem;" />Wieczorem wszyscy zostali wezwani za kotarę z napisem *private* w Rhymers Club, do prowizorycznego biura McBride'a w magazynie. Szef przywitał siostrzeńca ciepło.

> **Declan McBride:** „W końcu moja siostra jest mi tak bliska, że jesteś w zasadzie prawą ręką w naszej skromnej grupie."

### [10:00–20:00] Dwa bimbry i przesłuchanie Brocka

McBride przeszedł do rzeczy. Wyjął szklaną butelkę z mętną cieczą — okazała się obrzydliwym, niepijalnym bimbrem typowym dla okolicy. Potem wyciągnął drugą, z pozoru identyczną zieloną butelkę po winie, w której płynął ciemnozłoty, whisky-burbonowo wyglądający trunek najwyższej jakości, godny tego, co importuje się z Kanady.

> **Declan McBride:** „To jest po prostu fenomenalne."

Problem: w mieście pojawił się ktoś z zewnątrz, kto dystrybuuje ten złoty trunek. Jeden z „luźnych szczurków" organizacji odkupił od niego towar, miał go przynieść — ale postanowił zarabiać na własną rękę. Człowiek ten czeka w sąsiednim, wygłuszonym pokoju i nie chce zdradzić źródła.

Drzwi zamknęły się za drużyną. Do krzesła był przywiązany pobity mężczyzna o nazwisku **Brock** — krwawiący, z paroma wybitymi zębami leżącymi na betonowej podłodze, w kącie zakrwawiony łom. James Kelly podniósł jeden z zębów, obrócił go w dłoniach i schował do kieszeni.

> **James Kelly:** „Wiesz, seryjni mordercy często zachowują sobie pamiątkę po swoich ofiarach. Coś małego. Paznokieć. Ząb. Jeżeli nie chcesz, żeby ten los spotkał ciebie, radzę, żebyś zaczął rozmawiać."
> **James Kelly:** „Nie jestem twoim szefem. Jestem twoim katem."

### [20:00–32:00] Wydobycie nazwiska Carmody

Cormac McMiller spróbował miękkiego podejścia — poklepał Brocka po ramieniu, obiecał ludzkie traktowanie. Fritz tymczasem poszedł napełnić wiadro lodowatą wodą, by otrzeźwić więźnia. Brock, przekonany, że i tak zginie, twierdził, że nie ma motywacji mówić. Przełom przyszedł, gdy James i Cormac wyczuli jego słaby punkt — matkę.
...
Mortimer zameldował wszystko stryjowi. McBride pochwalił robotę i wydał jasne instrukcje: dogadać się z bimbrownią na wyłączną dystrybucję, przemoc tylko w ostateczności. Przede wszystkim jednak:

> **Declan McBride:** „Nie chcę, żeby jakaś losowa salwa albo niepoważnie rzucona laska dynamitu zakończyła istnienie tego przybytku, gdzie oni to wytwarzają. Jeżeli ma być przemoc — szybko i skutecznie."

Brocka dobito. Joseph wziął łom i jednym ciosem zmiażdżył czaszkę. Ciało owinięto, obciążono i zatopiono w zatoce.

### [43:00–55:00] Przygotowania, droga i butelka „optymizmu"

Drużyna zabrała sprzęt: liny, łom, lampę naftową, aparat fotograficzny, broń krótką, strzelby. Fritz miał w bagażniku cztery Tommy Guny, o czym reszta dowiedziała się dopiero teraz, ku swojemu rozdrażnieniu. Wzięli dwa luksusowe firmowe auta. Przy wyjeździe wyszło na jaw, że James jest byłym alkoholikiem, który wyszedł z nałogu dzięki boksowi.

> **James Kelly:** „Moje usta nie dotykają alkoholu."
> **Mortimer Flannery:** „Panie Miller, o to właśnie w życiu chodzi. O te ulotne chwile, kiedy smakuje pan czegoś, czego nikt inny nie ma. Smakuje jak tęcza."
...
![Droga do Blackwater Creek](/img/ug2/road.jpg)
*Droga ku Blackwater Creek — pustkowia za Arkham.*

### [55:00–1:06:00] Blackwater Creek — pastor Sprouston

![Miasteczko Blackwater Creek](/img/ug2/town.jpg)
*Blackwater Creek — kościół i błotnisty rozjazd pośród pól.*

<img src="/img/ug2/sprouston.jpg" alt="Dick Sprouston" width="220" align="right" style="margin: 0.3rem 0 0.8rem 1.2rem;" />Auta wjechały na centralny plac — kilka chałup, sklep i kościół, dzieci bawiące się w błocie. Z kościoła wyszedł podstarzały mężczyzna w koloratce.
...
<img src="/img/ug2/carmody.jpg" alt="Damien Carmody" width="220" align="right" style="margin: 0.3rem 0 0.8rem 1.2rem;" />Przy bimbrowni siedział typ ze strzelbą; po słowach Cormaca o interesach zawołał Carmody'ego. Zebrała się grupka: pomocnik ze strzelbą (Jack), pomocnik z wojskowym karabinem oraz sam **Damien Carmody** z rewolwerem wciśniętym za pasek. James trzymał się z tyłu.
...
<img src="/img/ug2/pete.jpg" alt="Stary Pete" width="200" align="right" style="margin: 0.3rem 0 0.8rem 1.2rem;" />Na **Farmie Jarveyów** (tu wraca nagranie) działa pięcioro akademików: **Dr Arthur Henry Corwin**, **Dr Elaine Howard**, **Dr Herbert West**, bibliotekarz **Wallace Harvey** i **Dr Cecil Cavendish**. Dr Howard podeszła do **Starego Pete'a**, alkoholicznego parobka Jarveyów, siedzącego w błocie — bladego, półprzytomnego; gdy go zagadnęła, cienka czarna stróżka ropistego płynu zaczęła mu spływać wzdłuż wargi. Dr West dyskretnie pobrał próbkę. Wewnątrz domu znaleziono niedokończony, wielokrotnie przekreślany list zaczynający się od słów „Drogi Ernesti" — adresowany do **Ernesta McTavisha**, emerytowanego profesora Boston University i zleceniodawcy wyprawy Roadesa.

> **List (czyta Corwin):** „Blackwater Creek rzeczywiście zostało zbudowane w miejscu, gdzie niegdyś stała przystań Cayda. Odkryłem wiele artefaktów wczesnego osadnictwa, a także szczątki... Jest tu tak wiele, że czasami słyszę głos swojej matki. Znam ten głos. Jaskinia nie jest mitem. Cayda próbował ją zawalić, ale ona tam jest, jakby nigdy nie umarła. Postarałem się o dynamit. Muszę ją uwolnić. Boże, bądź miłościw mnie grzesznemu."

Wiedza historyczna Corwina: **Cayda** był przywódcą małej purytańskiej sekty, która opuściła Boston z powodu prześladowań i założyła przystań, jaka później bez śladu zniknęła z kart historii.

### [1:30:00–1:40:00] Most, wykopalisko i spalone kości

![Obóz i wykopalisko Roadesa](/img/ug2/dig.jpg)
*Porzucone wykopalisko profesora — rozkopane rowy nad wyschniętym strumieniem.*

Tropem listu i strumienia akademicy dotarli do czerwonego mostu, a potem do **porzuconego wykopaliska** profesora. Po godzinie pracy odsłonięto głębszy dół: kupa ludzkich kości — czaszek, piszczeli — potwornie zdeformowanych: spłaszczonych, rozciągniętych, rozchodzących się pod dziwnymi kątami. Co więcej:

> **Strażnik Tajemnic:** „Kości noszą znaki spalenia. Wygląda na to, że osoby, do których należały, zostały spalone — czy żywcem, czy wcześniej, nie wiadomo."

Datowanie wskazało koniec XVII wieku — pozostałość po zaginionej sekcie. Widok nadwerężył psychikę części badaczy. Paleniska znajdowały się na samym skraju lasu, w który niegdyś wpływał strumień.

![Las ku jaskini](/img/ug2/forest.jpg)
*Skażony las, w który wpływał strumień — droga ku jaskini.*

### [1:40:00–1:48:00] Spory akademików i decyzja o farmie
...
*Brendan Carmody — Dziecię Macierzy, „strach na wróble" z nocnej warty.*
...
<img src="/img/ug2/roades.jpg" alt="Henry Roades" width="220" align="right" style="margin: 0.3rem 0 0.8rem 1.2rem;" />W trakcie walki **Cormac McMiller** popadł w obłęd i w panice uciekł solo jednym z aut — przeżył, ale zniknął z gry. Po śmierci istoty pojawił się zniewolony, uwolniony z podziemi profesor:
...
*Matka — Abigail Roades, awatar wynurzający się z jaskinnego jeziora.*
...
**Scena pierwsza — Joseph Kelly.** Samotny, pusty bez brata, Joseph siedzi w swoim parterowym mieszkaniu, wpatrzony w sufit. Przez okno spogląda na niego ktoś.
