...
- [ ] Routing skeleton (react-router v7) with public routes
- [ ] Cthulhu skin: port palette + fonts from `C:\temp\bookstack-test\cthulhu-skin-minimal.html` into Tailwind v4 theme
- [ ] Left-sidebar Shelf list (always visible, large titles)
- [ ] Breadcrumbs component
- [ ] Markdown render: Polish characters, wikilinks `[[X]]` / `[[X|alias]]` → internal links, images, tables, code, blockquotes
